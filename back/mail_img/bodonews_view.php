<?
	...
	$query = "select * from tb_bodonews where NewsId = '".$NewsId."' and SeqNo = '".$id."'";
	...
	$sYY1 = substr("$s_Date", 0, 4); 
	$sMM1 = substr("$s_Date", 4, 2);
	$sDD1 = substr("$s_Date", 6, 2);
...
<tr>
	...
	<td>
		<input type="text" name="Source" size="30" value="<?echo $Source?>">
	</td>
</tr>
<tr>
	<th>
