...
# Modlue       : 
# Writer       : JeGal Jeong / Park Tae Jun
...
#====================================================================
	...
	$g_physical_path = "/home/httpd/homepage/"; 

	# 사이트 절대 경로
	Global  $g_old_data_path; 
	$g_old_data_path = "/home/httpd/homepage/upload_data/"; 

	//echo $g_physical_path;

	Global  $g_site_domain;
	$g_site_domain	= "admin.ucomp.co.kr";

	Global  $g_site_url;
	$g_site_url	= "http://admin.ucomp.co.kr";
	...
	$g_admin_email_01	= "jk0601@ucomp.co.kr";

	Global  $g_admin_email_02;
	$g_admin_email_02	= "jk0601@ucomp.co.kr";

	Global  $g_admin_email_03;
	$g_admin_email_03	= "jk0601@ucomp.co.kr";
