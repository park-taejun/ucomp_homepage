	...
	<div class="header">
		<div class="innerbox">
			<h1><a href="/admin/main/main.php"><img src="../images/logo.png" alt="U: 유컴패니온" /></a></h1>
			...
			<?
				...
				if (sizeof($arr_rs_menu) > 0) {
					...
					for ($m = 0 ; $m < sizeof($arr_rs_menu); $m++) { 
						// echo "M_MENU_CD : " .$M_MENU_CD. "<br />";
						// echo "M_MENU_URL : " .$M_MENU_URL. "<br />";
						$M_MENU_CD		= trim($arr_rs_menu[$m]["MENU_CD"]);
						$M_MENU_NAME	= trim($arr_rs_menu[$m]["MENU_NAME"]);
						$M_MENU_URL		= trim($arr_rs_menu[$m]["MENU_URL"]);
						
						/*
						if ( $M_MENU_URL == "/manager/admingroup/admingroup_list.php?menu_cd=0102" ) {
							// $M_MENU_URL = "/admin/admingroup/admingroup_list.php?menu_cd=0102";
							echo "12345";
						}
						 */
