...
?>
					...
					<li>						
						<div class="photo">
							<img src="/upload_data/partner/<?=$P_DOWN_IMG?>" onmouseover="this.src='/upload_data/partner/<?=$P_UP_IMG?>'" onmouseout="this.src='/upload_data/partner/<?=$P_DOWN_IMG?>'" /><? echo " j : " .$j. "<br />";?>
						</div>
						<br />
					</li>								 
					<? } else { ?>
