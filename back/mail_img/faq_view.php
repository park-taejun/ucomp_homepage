<?
	...
	$query = "select * from tb_faq where faq_id = '$faq_id' ";
	#echo $query; 
...
<tr>
	...
	<td width="85%" bgcolor="#EEEEEE" colspan="3">
		<input type="text" name="title" size="70" value="<?echo $title?>">
	</td>
</tr>
<tr>
	<td width="15%" bgcolor="#DDDDDD" align="right">
	...
	<td width="85%" bgcolor="#EEEEEE" colspan="3">
		<textarea name="faq" cols="75" rows="15"><?echo $faq?></textarea>
	</td>
</tr>
</TABLE>
	</td>
