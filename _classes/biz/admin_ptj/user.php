<?
	...
	function listUserTest($db, $group_no, $headquarters_code, $dept_code, $position_code, $use_tf, $del_tf, $search_field, $search_str, $nPage, $nRowCount) {
	...
	function totalCntUserTest($db, $group_no, $headquarters_code, $dept_code, $position_code, $use_tf, $del_tf, $search_field, $search_str) {
