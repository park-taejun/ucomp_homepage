<?
	...
	$memo = $list[memo];
	$eng_memo = $list[eng_memo];
	$writer = $list[writer];
	$data = $list[Content];
	$eng_data = $list[eng_Content];
	...
	#$eng_data = stripslashes(Trim($eng_data)); 

	$data = str_replace("\"","'",$data); 
	$eng_data = str_replace("\"","'",$eng_data); 

	$in_date_v = str_replace("-","", $in_date);

	$Title = htmlspecialchars($Title);	
	$eng_Title = htmlspecialchars($eng_Title);	
	#$eng_data = htmlspecialchars($eng_date);
...
<!-- Page Description End -->						
						<table cellpadding="2" cellspacing="1" border="0" width="95%"> 
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<textarea name="memo" cols="50" rows="3"><?echo $memo?></textarea>
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<textarea name="eng_memo" cols="50" rows="3"><?echo $eng_memo?></textarea>
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								<td width="15%" bgcolor="#E9E9E9" align="center" height="25">촬영일</td>
								<td style="padding-left:10px" colspan="3">
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											...
											<td width="80%">
												...
												<input TYPE="file" NAME="ImageName02" size="30" style="visibility:hidden">
											</td>
										</tr>
									</table>
								<?
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3" bgcolor="#FFFFFF">
									...
									<input type="hidden" name="eng_data" value="<?echo $eng_data?>">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
