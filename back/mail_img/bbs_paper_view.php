...
?>		
<?	$_mode = "view"; ?>
<?	include "./inc/bbs_paper_title.inc"; ?>
<HTML>
<HEAD>
...
//		document.frm.target = "frmain";
		document.frm.action="bbs_paper_list.php";
		document.frm.submit();
	}
...
//		document.frm_file.target = "frhidden";
	...
	function goIn() {
		...
		if( checkIt(document.frm) ){
			document.frm.action = "bbs_paper_db.php";
		  document.frm.submit()
		} else {
		  return;
		}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FBFBFB"> 
	<tr>
		<td height="30" style="padding-left:20px"><a href="#">연구활동관리 관리</a> > <a href="#"><?echo $_menu_str?></a> > <a href="#"><?echo $_mode_str?></a></td>
	</tr>
	<tr>
...
<!-- Form -->				
				<form name='frm' method='post' action='bbs_paper_db.php' enctype='multipart/form-data'>
...
<!-- Page Description End -->						
						<table cellpadding="2" cellspacing="1" border="0" width="95%"> 
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="source" size="40" value="<?echo $source?>">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								<td width="15%" bgcolor="#E9E9E9" align="center" height="25">계재일</td>
								<td style="padding-left:10px" colspan="3">
							...
							<tr>
								<td width="15%" bgcolor="#E9E9E9" align="center" height="25">원문 URL</td>
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="Ref_url" size="90" value="<?echo $Ref_url?>">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											...
											<td width="80%">
												...
												<input TYPE="file" NAME="FileName01" size="50" style="visibility:hidden">
											</td>
										</tr>
									</table>
								<?
								...
								?>	
									<input type="file" name="FileName01" size="50" value="">&nbsp;&nbsp; 
