												...
												<div class="subsection-body">
													<div class="data-display module-a type-c style-b">
														<ul class="data-list">
															...
															<li class="data-item">
																<div class="data-wrap">
																	<div class="data-head"><span class="data-name">Trend</span></div>
																	<div class="data-body"><span class="wbr">우리는 <span class="em">트렌드</span>를</span> <span class="wbr">스스로 만들어 나간다.</span></div>
																</div>
															</li>
															<li class="data-item">
																<div class="data-wrap">
																	<div class="data-head"><span class="data-name">Initiative</span></div>
																	<div class="data-body"><span class="wbr">우리는 <span class="em">주체성</span>을 갖고</span> <span class="wbr">휘둘리지 않는다.</span></div>
																</div>
															</li>
															<li class="data-item">
																<div class="data-wrap">
																	<div class="data-head"><span class="data-name">Objective</span></div>
																	<div class="data-body"><span class="wbr">우리의 <span class="em">목표</span>는</span> <span class="wbr">명확히 실현한다.</span></div>
																</div>
															</li>
														</ul>
													</div>
