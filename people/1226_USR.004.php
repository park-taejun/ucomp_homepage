					...
					<div id="content">
						...
						<div class="content-body">
							...
							<div class="section module-a style-a type-a our-team" id="ourTeam" data-bui-animation="type-1">
								<div class="section-wrap" value="<?=$P_TEAM_IMG_TOP?>" style="--background-image: url(../../assets/images/people/team_01.png);">
									<div class="section-head">
									...
									<div class="section-body">
										...
										<input type="hidden" name="team_img" value="<?=$$P_TEAM_CONTENTS_IMG?>">
...
<script type="text/javascript">	
	...
	function js_team_li(){		 
		...
		$("#navi_list").on("click", "li", function() {
			...
			frm.team_img.value = $('.section-wrap').attr("value");  
			
			// alert($('#para_contents').value());
			
			$('.para').text(frm.team_contents.value);
