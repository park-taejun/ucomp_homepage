				...
				<caption>게시판 생성</caption>
					...
					<tbody>
						...
						<tr>
							<th>휴대폰번호</th>
							<td>
								<?=$arr_m_tel[0]?> - <?=$arr_m_tel[1]?> - <?=$arr_m_tel[2]?>
								&nbsp;&nbsp;
								(<? if ($rs_m_sms == "1") { echo "수신동의"; }  else { echo "수신거부"; } ?>)
							</td>
							<th>연락처</th>
						...
						<tr>
							...
							<td colspan="3">
								<?=$rs_m_email?>
								&nbsp;&nbsp;
								(<? if ($rs_m_mailling == "1") { echo "수신동의"; }  else { echo "수신거부"; } ?>)
							</td>
						</tr>
						...
						<tr>
							<th>조직</th>
							<td colspan="3"><?=getOrganizationName($conn,$rs_m_organization)?>
					...
					<div class="btnArea">
						<ul class="fRight">
							...
							?>
							<li><a href="javascript:js_modify('<?=$m_no?>');"><img src="../images/btn/btn_rewrite.gif" alt="수정" /></a></li>
							<?
									if ($m_no <> "") {
										if ($sPageRight_D == "Y") { 
							?>
							<li><a href="javascript:js_delete();"><img src="../images/btn/quit_btn.gif" alt="탈당" /></a></li>
							<?
										}
 									}
								}
