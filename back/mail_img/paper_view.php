<?
	...
	$query = "select * from tb_call_paper where code_id = '".$code_id."' and SeqNo = '".$SeqNo."'";
	$result = mysql_query($query);
	$list = mysql_fetch_array($result);

	$SeqNo = $list[SeqNo];
	$code_id = $list[code_id];
	$Title = $list[Title];
	...
	$start_date_v = str_replace("-","",$start_date);
	$end_date_v = str_replace("-","",$end_date);
	$du_date_v = str_replace("-","",$du_date);
