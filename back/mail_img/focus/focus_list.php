...
function onView(id) {
	...
	document.frmSearch.action= "focus_view.php";
	document.frmSearch.submit();
}

function goIn() {
	document.frmSearch.action= "focus_input.php";
	document.frmSearch.submit();
}
...
function goDel() {
	...
	if ( bDelOK ==true ) {
		...
		document.frmSearch.action = "focus_db.php";
		document.frmSearch.submit();
	}
	else {
		return;
...
<!-- Site Map Section End -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td width="99%">
<!-- Form --->					
					<FORM name="frmSearch" method="post" action="focus_list.php">
