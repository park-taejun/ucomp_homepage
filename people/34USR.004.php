					...
					<div id="content">
						...
						<div class="content-body">
							...
							<div class="section module-a style-a type-a our-team" id="ourTeam" data-bui-animation="type-1">								
								<div class="section-wrap" style="--background-image: url(../../assets/images/people/team_01.png);">
									<div class="section-head">
									...
									<div class="section-body">
										...
										<div class="dropdown module-a style-a">
											<div class="dropdown-wrap">
												...
												<div class="dropdown-head">
													<p class="dropdown-subject" tabindex="0" data-bui-tab-selected="기획팀"><span class="dropdown-name">항목선택</span></p>
												</div>
												-->
												<div class="dropdown-head">
													
													<ul class="navi-list">
													<select id="selectBox_test" name="Level" class="navi-item" style="border:none; ">
														<option value="">항목선택</option>
														<? 
															$query = " SELECT TEAM_NO, TEAM_NM, TEAM_CONTENTS FROM TBL_TEAM WHERE USE_TF = 'Y' AND DEL_TF = 'N' ORDER BY DISP_SEQ ASC, REG_DATE DESC ";
															$data = mysql_query($query,$conn);

															while($rows = mysql_fetch_array($data)) {
														?>
																<option value="<?=$rows['TEAM_CONTENTS'];?>" class="navi-text"><?=$rows['TEAM_NM'];?></option>
														<?
															}
														?> 
													</select>
													<!--<ul class="navi-list">-->
														<!--
														<li class="navi-item current" title="현재 선택된 항목"><a class="navi-text" href="#" onclick="alert('test');"><?=$P_TEAM_NM?></a></li>														
														<li class="navi-item current" title="현재 선택된 항목"><a class="navi-text" href="#" onclick="alert('test');">기획팀</a></li>
														<li class="navi-item"><a class="navi-text" href="#">UXD팀</a></li>
														<li class="navi-item"><a class="navi-text" href="#">Backend팀</a></li>
														<li class="navi-item"><a class="navi-text" href="#">Frontend팀</a></li>
														<li class="navi-item"><a class="navi-text" href="#">Data Analystics팀</a></li>
														<li class="navi-item"><a class="navi-text" href="#">UX연구소</a></li>
														<li class="navi-item"><a class="navi-text" href="#">기업부설 연구소</a></li>
														-->													
													</ul>
												</div>
											</div>
										...
										<!-- //dropdown -->
										<p class="para"><span class="wbr"><textarea  style="width:100%; height:50px; border:none; resize: none;" name="txt_team_contents" id="team_contents" maxlength="20" ></textarea></span></p>
									</div>
								</div>
							</div>
							<!-- //section -->
																...
																<div class="board-wrap">
																	...
																	<div class="board-util">
																		...
																		<div class="button-display module-a style-a type-a">
																			<span class="button-area">
																				<a class="btn module-b style-c type-line normal-01 large-2x symbol-rtl-small-arrow-right" href="https://www.saramin.co.kr/zf_user/company-info/view-inner-recruit?csn=WTlBL2VuQ3d0ZlZSSmorU0dlaXdPdz09" onclick="window.open(this.href, '_blank'); return false;"><span class="btn-text">채용 공고 바로가기</span></a>
																			</span>
																		</div>
																		<!-- //button-display -->
																	</div>
															...
															<div class="board-item">
																<div class="board-wrap">
																	...
																	<div class="board-util">
																		...
																		<div class="button-display module-a style-a type-a">
																			<span class="button-area">
																				<a class="btn module-b style-c type-line normal-01 large-2x symbol-rtl-small-arrow-right" href="https://www.jobkorea.co.kr/Recruit/Co_Read/Recruit/C/ucomp8741" onclick="window.open(this.href, '_blank'); return false;"><span class="btn-text">채용 공고 바로가기</span></a>
																			</span>
																		</div>
																		<!-- //button-display -->
																	</div>
...
<script type="text/javascript">
	$(function(){
		$('#selectBox_test').change(function(){
		
			var team_contents = $('#selectBox_test option:selected').val(); 
			
			frm.txt_team_contents.value = team_contents; 
		});
	});
</script>