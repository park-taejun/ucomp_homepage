...
#====================================================================
	...
	$str_title = iconv("UTF-8","EUC-KR","탈당리스트");
...
#===============================================================
	...
	$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "탈당리스트 엑셀 출력", "Excel");

?>
<font size=3><b>탈당 리스트 </b></font> <br>
<br>
출력 일자 : [<?=date("Y년 m월 d일")?> ]
<br>
<br>
<table border="1">
	<tr>
		...
		<td align='center' bgcolor='#F4F1EF'>탈당일</td>
		<td align='center' bgcolor='#F4F1EF'>관리자메모</td>
	</tr>
	<?
		if (sizeof($arr_rs) > 0) {
