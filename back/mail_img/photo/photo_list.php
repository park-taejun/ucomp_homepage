...
<!-- Site Map Section End -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td width="99%">
<!-- Form --->					
					<FORM name="frmSearch" method="post" action="photo_list.php">
						...
						<table cellpadding="0" cellspacing="1" border="0" width="95%"> 
							...
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="9"></td>
							</tr>							
							<?
										}
										$NumberArticle--;
							...
							<?
								...
								if ($TotalArticle > $ListArticle) {
									...
									if (($TotalArticle + 1) > ($ListArticle * $PageScale)) {
										...
										if ($PrevPage >= 0)
											echo "&nbsp;[<a href='".$PHP_SELF."?page=".($PrevPage + 1)."&sel_source=$sel_source&idxfield=$idxfield&BoardId=$BoardId&qry_str=$qry_str'>이전".$PageScale."개</a>]";
									}
									echo "&nbsp;";
									// 페이지 번호
