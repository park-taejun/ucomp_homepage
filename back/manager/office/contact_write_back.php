...
#====================================================================
	...
	if ($area_cd_01) $area = $area_cd_01;
	if ($area_cd_02) $area = $area_cd_02;

	if ($mode == "I") {

		$result =  insertOffice($conn, $area, $name, $type, $tel01, $tel02, $fax01, $fax02, $email, $post, $address, $str_lat, $str_lng, $ex_info01, $ex_info02, $ex_info03, $use_tf, $s_adm_no);
	...
	if ($mode == "U") {
		...
		$result = updateOffice($conn, $area, $name, $type, $tel01, $tel02, $fax01, $fax02, $email, $post, $address, $str_lat, $str_lng, $ex_info01, $ex_info02, $ex_info03, $use_tf, $s_adm_no, $seq_no);
...
<input type="hidden" name="area_cd_02" value="<?=$rs_area?>" />
			...
			<table summary="이곳에서 <?=$p_menu_name?>을 입력하실 수 있습니다" class="bbsWrite">
				...
				<tr>
					...
					<td colspan="3" class="line">
						<?
							//$rs_area
						?>
						<?=makeSelectBoxOnChange($conn,"AREA","area_cd_01","128","지역을 선택하세요.","", left($rs_area,4))?>&nbsp;
						<span id="next_area">
						</span>
					</td>
				</tr>
				...
				<tr>
					<th>연락처 02</th>
					<td colspan="3" class="line">
						<input type="text" class="txt" name="tel02" value="<?=$rs_tel02?>" style="width: 15%;" />
					</td>
				</tr>
				...
				<tr>
					<th>팩스 01</th>
					<td colspan="3" class="line">
						<input type="text" class="txt" name="fax01" value="<?=$rs_fax01?>" style="width: 15%;" /> 예) 02-2139-7777
					</td>
				</tr>
				...
				<tr>
					<th>팩스 02</th>
					<td colspan="3" class="line">
						<input type="text" class="txt" name="fax02" value="<?=$rs_fax02?>" style="width: 15%;" />
					</td>
				</tr>
				-->
				<tr>
					<th>주소</th>
					<td colspan="3" class="line">
						<input type="hidden" name="post" value="<?= $rs_post ?>">
