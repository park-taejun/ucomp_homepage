...
<!-- Site Map Section -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FBFBFB"> 
				<tr>
					<td height="30" style="padding-left:20px"><a href="#">게시판 관리</a> > <a href="#">게시판 관리</a> > <a href="#">등록</a></td>
				</tr>
				<tr>
						...
						<table cellpadding="2" cellspacing="1" border="0" width="95%"> 
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="BOARD_NAME" size="35" value="">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="USER_ID" size="15" value="">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="USER_PW" size="15" value="">
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<textarea name="BOARD_CONT" cols="60" rows="3"></textarea>
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="checkbox" name="chk_USE_FLAG" size="15" value=""> 사용함
