...
<%
' =============================================================================
' File Name    : pop_pcode_dup.asp
' Modlue       : ihico > manager > code > pcode duplicate check
' Writer       : Park Chan Ho 
...
' Get Data
' ==========================================================================
	objRS.Open "AGet_Parent_Code_Dup "& sParameter, objDbCon
...
<script language="javascript" src="/manager/js/overseas.js"></script>
...
<!--	
	...
	function send_close() {
		...
		opener.document.frm.pcode.value = document.frm.pcode.value;
		self.close();	
...
<form name="frm" action="pop_pcode_dup.asp" method="post">
						...
						<table cellpadding="2" cellspacing="1" border="0" width="90%"> 
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="text" name="pcode" size="20" value="<%=sPcode%>" maxlength="6"> 
								</td>
								<td>
...
%>						
						...
						<table cellpadding="2" cellspacing="1" border="0" width="90%"> 
							<tr>
								<td>
									* <b><%=sPcode%></b> 는 사용 하실 수 있는 값입니다.<!--는 사용 하실 수 있는 값입니다.--><br>
								</td>
							</tr>
						</table>
<%
...
%>
						...
						<table cellpadding="2" cellspacing="1" border="0" width="90%"> 
							<tr>
								<td>
									* <b><%=sPcode%></b> 는 이미 사용 하고 계시는 값입니다. <!--는 이미 사용 하고 계시는 값입니다.--><br>
									<script language="javascript">document.frm.pcode.value="";</script>
								</td>
							</tr>
						</table>
<%
