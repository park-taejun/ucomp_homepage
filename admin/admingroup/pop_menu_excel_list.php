...
#====================================================================
	...
	$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "관리자 권한 조회 엑셀다운 (그룹 번호 : ".$group_no.") ", "List");
...
<div id="popupwrap_file">
		...
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<table id='t' cellpadding="0" class="rowstable" cellspacing="0" border="1">
						<colgroup>
							<col width="15%">
							<col width="12%">
							<col width="12%">
						...
						<thead>
							<tr>
								<th colspan="6" style="border-color:white;"><h2>[<?=$rs_group_name?>]그룹 권한 리스트</h2></th>
							</tr>
						...
						?>
							<tr align="center" height="25" bgcolor="#FFFFFF">
								<td class="modeual_nm" style="text-align:left;">
									<?=$menu_str?>
								</td>				
						<?
