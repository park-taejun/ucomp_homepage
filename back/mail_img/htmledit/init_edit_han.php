...
<TEXTAREA ID='ContentArea' STYLE='display:none;'><?=$data?></TEXTAREA>
<IFRAME NAME='EditFrame' SRC='/manager/htmledit/edit_han.php?image_path=<?echo $image_path?>' WIDTH=100% HEIGHT=100% FRAMEBORDER=0></IFRAME>
<?else:?>
<INPUT TYPE=HIDDEN NAME='BB_HTML' VALUE="TEXT">
<TEXTAREA NAME='BB_CONTENT' ROWS=15 COLS=70 STYLE='width:100%;height:100%;padding:5px;'><?=$data?></TEXTAREA>
<?endif;?>
