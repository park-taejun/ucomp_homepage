...
#====================================================================
	...
	$str_title = iconv("UTF-8","EUC-KR","당원 현황");
	...
	$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "일자별 당원 현황 엑셀 출력", "Stats");
...
<table border="1">
	<tr>
		...
		<? } ?>
		<td align='center' bgcolor='#F4F1EF'>입당</td>
		<td align='center' bgcolor='#F4F1EF'>탈당</td>
	</tr>
	<?
