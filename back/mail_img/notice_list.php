<?
	...
	if (!empty($qry_str)) {
		...
		$query = "select count(*) from tb_board where BoardId = '".$BoardId."' ".$que;
		$query2 = "select * from tb_board where BoardId = '".$BoardId."' ".$que. " order by RegDate desc";

	} else {
		$query = "select count(*) from tb_board where BoardId = '".$BoardId."'";
		$query2 = "select * from tb_board where BoardId = '".$BoardId."' order by RegDate desc";
	}
...
function onView(id) {
	...
	document.frmSearch.action= "notice_view.php";
	document.frmSearch.submit();
}

function goIn() {
	document.frmSearch.action= "notice_input.php";
	document.frmSearch.submit();
}
...
function goDel() {
	...
	if ( bDelOK ==true ) {
		...
		document.frmSearch.action = "notice_db.php";
		document.frmSearch.submit();
	}
	else {
		return;
...
<!-- Site Map Section End -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td width="99%">
<!-- Form --->					
						<FORM name="frmSearch" method="post" action="notice_list.php">
						...
						<table cellpadding="0" cellspacing="1" border="0" width="95%"> 
							...
							<tr align="center" height="25" onmouseover="this.style.background='#E9E9E9';" onmouseout="this.style.background='White';">
								...
								<td align="left" style="padding: 0 0 0 10"><?echo $obj->Title?></td>
								<td><?echo $date_s?></td>
							</tr>
							<tr>
