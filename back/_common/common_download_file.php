...
<?
	...
	$str_path = $g_physical_path."upload_data/common/";
...
//die;
	...
	if($field!="IMAGE"){
		//$query ="insert into CTBL_DOWNLOAD_CNT values('$bb_code','$bb_no','$filename_rnm','0')";
...
// /_common/common_download_file.php?filename_rnm=파일네임&file_name=한글파일네임
?>
