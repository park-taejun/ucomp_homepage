...
# =============================================================================
# File Name    : approval_all_list.php
# Modlue       : 
# Writer       : JeGal Jeong
			...
			<div id="local">
				...
				<div class="local-body">
					...
					<div id="content">
						...
						<div class="content-head">
							...
							<div class="tab-display module-c style-a type-d medium">
								...
								<? if (($LEADER_YN == "Y") || ($s_adm_no == 1) || ($s_adm_no == 178) || ($s_adm_no == 4) || ($s_adm_no == 43) || ($s_adm_no == 44)) { ?> 
									<li class="tab-item"><a class="tab-name" href="approval_list.php">지출결재</a></li>
						...
						<? 
							$state  = 4; //신청
							$arr_rs = listApprovalIng($conn, $s_adm_no, $state, $my_dept_code, $order, $search_field, $search_str, $today_y, $today_m); 
						?>
							<!-- post-display -->
