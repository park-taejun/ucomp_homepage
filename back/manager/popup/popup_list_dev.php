...
function view_pop(pop_no,size_w, size_h,top,left_,scrollbars){
	//var features = 'top=0,left=0,toolbar=yes,scrollbars=yes';
	alert(size_w);
	window.open('../../main/preview_popup_dev?pop_no='+pop_no,'test','width='+size_w+',height='+size_h+',top='+top+',left='+left_+',scrollbars='+scrollbars);
}
...
<input type="hidden" name="nPageSize" value="<?=$nPageSize?>">
			...
			<fieldset>
				...
				<?
						require "popup_list_sub_dev.php";
