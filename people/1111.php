...
#=====================================================================
	...
	$team_no					= $_POST['team_nm']!=''?$_POST['team_nm']:$_GET['team_nm'];
							...
							<div class="section module-a style-a type-a our-team" id="ourTeam" data-bui-animation="type-1">
								<div class="section-wrap" style="--background-image: url(../../assets/images/people/team_01.png);">
									...
									<div class="section-body">
										...
										<div class="dropdown module-a style-a">
											<div class="dropdown-wrap">
												<div class="dropdown-head">
													...
													<p class="dropdown-subject" tabindex="0" data-bui-tab-selected="<?=$P_TEAM_NM_TOP?>" onclick="js_team();"><span class="dropdown-name"><?=$P_TEAM_NM_TOP?></span></p>
												</div>
												<div class="dropdown-body" >
													<ul class="navi-list" id="navi_list">
														...
														?>
														<li class="navi-item" value="<?=$P_TEAM_CONTENTS?>"><a class="navi-text"  href="javascript:void(0)" onClick="js_team();"><?=$P_TEAM_NM?></a></li>
														<!--
										...
										<!-- //dropdown -->
										<input type="hidden" name="TEAM_NO_TOP" value="<?=$P_TEAM_NM_TOP?>">
																...
																<div class="board-wrap">
																	...
																	<div class="board-util">
																		...
																		<div class="button-display module-a style-a type-a">
																			<span class="button-area">
																				<a class="btn module-b style-c type-line normal-01 large-2x symbol-rtl-small-arrow-right" href="#" target="_blank"><span class="btn-text">채용 공고 바로가기</span></a>
																			</span>
																		</div>
																		<!-- //button-display -->
																	</div>
...
<script type="text/javascript">	
	...
	function js_team_li(){		 
		$("#navi_list").on("click", "li", function() {
			frm.team_nm.value = $(this).text(); 
			frm.team_contents.value = $(this).attr("value"); 
			$('.dropdown-body').css('display', 'none');
			$('.dropdown-subject').attr('data-bui-tab-selected',frm.team_nm.value);
