...
//		document.frm.target = "frmain";
		document.frm.action="other_list.php";
		document.frm.submit();
	}
...
//		document.frm_file.target = "frhidden";
	...
	function goIn() {
		...
		if( checkIt(document.frm) ){
			document.frm.action = "other_db.php";
		  document.frm.submit()
		} else {
		  return;
		}
...
<!-- Form -->				
				<form name='frm' method='post' action='other_db.php' enctype='multipart/form-data'>
							...
							<tr>
								...
								?>	
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											<td width="20%">
												<a href="/manager/common/file_down.php?filename=<?echo $FileName01?>&filerealname=<?echo $FileRealName01?>"><?echo $FileRealName01?></a>&nbsp;
											</td>
											<td width="80%">
