					...
					<table>
						...
						<tbody>
							...
							<?
								// ================================================================== 수정 부분								
							?>
								 <span class="fl" style="padding-left:0px;width:90%;height:500px;"><textarea name="contents" id="contents"  style="padding-left:0px;width:100%;height:450px;"><?=$rs_contents?></textarea></span>
							<?
								// ================================================================== 수정 부분
							?>
								</td>
							...
							<input type="file" name="file_name[]" value="" style="display:none">
							...
							<tr>
								...
								<td colspan="3">
									...
									&nbsp;&nbsp;
									<select name="file_flag[]" style="width:70px;" onchange="javascript:js_exfileView('<?=$f_Cnt?>')">
										<option value="keep">유지</option>
										<option value="delete">삭제</option>
										<option value="update">수정</option>
									</select> 
									...
									<input TYPE="file" NAME="file_name[]" size="40%" style="visibility:hidden"> <?=$img_size?>
								</td>
							</tr>
							<?
												$f_Cnt = $f_Cnt + 1;
						...
						<?}?>
							...
							<input type="hidden" name="comment_tf" value="Y"> 
							<? } ?>
							...
							<tr> 
								...
								<td colspan="3">
							-->
									<input type="hidden" name="reg_date_ymd" value="<?=$reg_date_ymd?>" class="date" style="width:120px;" readonly="1">
									<input type="hidden" name="reg_date_time" value="<?=$reg_date_time?>" style="width:60px;"><!-- ex) 수정 시 '10:30:00' 포멧으로 입력
								</td>
							</tr>
							-->
