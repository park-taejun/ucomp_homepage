...
#====================================================================
	...
	$str_title = iconv("UTF-8","EUC-KR","CMS 특별당비출금리스트");
...
#===============================================================
	...
	$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "CMS 특별 당비 납부 엑셀 출력", "Excel");
...
?>
<font size=3><b>CMS 출금 리스트 (<?=$rs_title?>)</b></font> <br>
<br>
출력 일자 : [<?=date("Y년 m월 d일")?> ]
<br>
<br>
