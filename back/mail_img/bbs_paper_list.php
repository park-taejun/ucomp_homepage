...
function onView(id) {
	...
	document.frmSearch.action= "bbs_paper_view.php";
	document.frmSearch.submit();
}

function goIn() {
	document.frmSearch.action= "bbs_paper_input.php";
	document.frmSearch.submit();
}
...
function goDel() {
	...
	if ( bDelOK ==true ) {
		...
		document.frmSearch.action = "bbs_paper_db.php";
		document.frmSearch.submit();
	}
	else {
		return;
...
<!-- Site Map Section End -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td width="99%">
<!-- Form --->					
					<FORM name="frmSearch" method="post" action="bbs_paper_list.php">
						...
						<table cellpadding="0" cellspacing="1" border="0" width="95%"> 
							...
							<tr align="center" height="25" onmouseover="this.style.background='#E9E9E9';" onmouseout="this.style.background='White';">
								...
								<td align="center"><?echo $obj->source?></td>
								<td><?echo $date_in?></td>
								<td><?echo $date_s?></td>
								<td>
							<?
