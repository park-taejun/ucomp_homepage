<?
	...
	function selectMemberAsEmail($db, $m_id) {
		$query = "SELECT * FROM TBL_MEMBER WHERE M_EMAIL = '$m_id' AND M_LEAVE_DATE = '' ";
	...
	function confirmMember($db, $adm_id) {
	
		$query = "SELECT M_NO,M_ID,M_PASSWORD,M_NAME,M_NICK,M_NICK_DATE,M_EMAIL,M_HOMEPAGE,M_PASSWORD_Q,M_PASSWORD_A,M_LEVEL,M_JUMIN,M_SEX,M_BIRTH,M_TEL,M_HP,M_ZIP1,M_ZIP2,M_ADDR1,M_ADDR2,M_O_ZIP,M_O_ADDR1,M_O_ADDR2,
		M_SIGNATURE,M_RECOMMEND,M_POINT,M_TODAY_LOGIN,M_LOGIN_IP,M_DATETIME,M_IP,M_LEAVE_DATE,M_INTERCEPT_DATE,M_EMAIL_CERTIFY,M_MEMO,M_MAILLING,M_SMS,M_OPEN,M_OPEN_DATE,M_PROFILE,M_MEMO_CALL,
		M_1,M_2,M_3,M_4,M_5,M_6,M_7,M_8,M_9,M_10,M_11,M_12,M_13,SIDO,SIGUNGU,M_AREA,M_ORGANIZATION,M_ONLINE_FLAG,M_CMS_BIRTH,CMS_FLAG,SEND_FLAG,CMS_RESULT,CMS_RESULT_CODE,CMS_RESULT_MSG,QUIT_CMS_FLAG,
		REQ_DAY,NEW_PASSWARD 
		FROM TBL_MEMBER A WHERE M_EMAIL = '$adm_id' ";
