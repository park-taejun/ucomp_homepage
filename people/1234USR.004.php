											...
											<div class="dropdown-wrap">
												...
												<div class="dropdown-body" style="display:none">
													<ul class="navi-list" id="navi_list">
														...
														?>
														<li class="navi-item" value="<?=$P_TEAM_CONTENTS_IMG?>"><a class="navi-text"  href="javascript:void(0)" onClick="js_team();"><?=$P_TEAM_NM?></a></li>
														<!--
...
<script type="text/javascript">
	...
	function js_team_li() {
		...
		$("#navi_list").on("click", "li", function() {
			...
			frm.team_contents.value = $(this).attr("value").split('|')[1];
			frm.team_img.value = $(this).attr("value").split('|')[0];
			
			$('.para').text($(this).attr("value").split('|')[1]);
			
			$('.dropdown-body').css('display', 'none');
			$('#dropdown-subject').attr('data-bui-tab-selected',$(this).text());
			// $('#id_team_img').css('background-image:after','url(../../upload_data/team/'+$(this).attr("value").split('|')[0]+')');
			$('#id_team_img').css('background-image','url(../../upload_data/team/'+$(this).attr("value").split('|')[0]+')');
