						...
						<div class="content-body">
							...
							<div class="posts-read module-a style-a">							
								...
								<div class="posts-util">
									<a class="btn prev" href="/story/USR.005"><span class="text">이전페이지</span></a>
								</div>
								<!-- //posts-util --->
								<!-- posts-wrap -->
											...
											<div class="data-wrap">
												...
												?>
													...
													<span class="data-body">
														<a class="data-name" href="USR.005_1?story_no=<?=$P_NEXT_STORY_NO?>&story_gubun=v"><?=$P_NEXT_STORY_NM?></a>
													</span>
												<? } else { ?>
													<span class="data-head"><span class="data-name">다음글</span></span>
										...
										<li class="data-item next">											
											<div class="data-wrap">
												...
												?>  
													<span class="data-head"><span class="data-name">이전글</span></span>
													<span class="data-body">
														<a class="data-name" href="USR.005_1?story_no=<?=$P_PREV_STORY_NO?>&story_gubun=v"><?=$P_PREV_STORY_NM?></a>													
													</span>
												<? } else { ?>
													<span class="data-head"><span class="data-name">이전글</span></span>
													<span class="data-body">데이터가 없습니다.</span>
								...
								<!-- //posts-direction -->
								<!-- button-display -->
								<? if ( $P_STORY_TYPE == "U:Story" ) { ?>
									<div class="button-display module-a style-a type-c">								 
										<span class="button-area">
											<a class="btn module-b style-c type-fill normal-01 large-2x flex" href="USR.005_3?story_div=U:Story"><span class="btn-text">목록</span></a>
										</span>
									</div>
								<? } else if ( $P_STORY_TYPE == "News" ) { ?>
									<div class="button-display module-a style-a type-c">								 
										<span class="button-area">
											<a class="btn module-b style-c type-fill normal-01 large-2x flex" href="USR.005_3?story_div=News"><span class="btn-text">목록</span></a>
										</span>
									</div>
								<? } else if ( $P_STORY_TYPE == "Newsletter" ) { ?>
									<div class="button-display module-a style-a type-c">								 
										<span class="button-area">
											<a class="btn module-b style-c type-fill normal-01 large-2x flex" href="USR.005_3?story_div=Newsletter"><span class="btn-text">목록</span></a>
										</span>
									</div>
