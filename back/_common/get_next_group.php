...
#====================================================================
	...
	if (strlen($_SESSION['s_adm_organization']) >= "3") {
		if (sizeof($arr_rs) > 0) {
...
?>
<div style="padding-right:80px;display:inline;font-weight:bold"><?=getOrganizationShortName($conn,left($_SESSION['s_adm_organization'],3))?></div>
<input type="hidden" name="group_cd_01" id="group_cd_01" value="<?=left($_SESSION['s_adm_organization'],3)?>">
<?
	} else {
?>
...
<?
	...
	if (($group_cd_01 <> "") && ($is_depth_01 == "1")) {
		...
		if (strlen($_SESSION['s_adm_organization']) >= "6") {
...
?>
<div style="padding-right:80px;display:inline;font-weight:bold"><?=getOrganizationShortName($conn,left($_SESSION['s_adm_organization'],6))?></div>
<input type="hidden" name="group_cd_02" id="group_cd_02" value="<?=left($_SESSION['s_adm_organization'],6)?>">
<?
		} else {
?>
...
<?
	...
	if (($group_cd_02 <> "") && ($is_depth_02 == "1")) {
		...
		if (strlen($_SESSION['s_adm_organization']) >= "9") {
...
?>
<div style="padding-right:80px;display:inline;font-weight:bold"><?=getOrganizationShortName($conn,left($_SESSION['s_adm_organization'],9))?></div>
<input type="hidden" name="group_cd_03" id="group_cd_03" value="<?=left($_SESSION['s_adm_organization'],9)?>">
<?
		} else {
?>
