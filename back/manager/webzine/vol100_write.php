...
<script language="javascript">
		alert('정상 처리 되었습니다.');
		document.location.href = "vol100_list.php<?=$strParam?>";
</script>
</head>
</html>
<?
...
function js_list() {
	document.location = "vol100_list.php<?=$strParam?>";
}
				...
				<tr>
						<tr>
							...
							<td colspan="3">
								...
								?>
								<?=makeSelectBoxWebzine($conn,"webzine_info","250","선택하세요.","",$webzine_info)?>
							</td>
						</tr>
						<tr>
							<th scope="row">구분</th>
							<td colspan="3">
								<?= makeSelectBox($conn,"EVENT_TYPE","type","225","선택","",$rs_type)?>
							</td>
						</tr>
						<tr>
							<th scope="row">타이틀</th>
