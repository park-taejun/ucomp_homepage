...
//		document.frm.target = "frmain";
		document.frm.action="focus_list.php";
		document.frm.submit();
	}
...
<!-- Main Section  -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<form name='frm' method='post' action='focus_db.php' enctype='multipart/form-data'>
...
<!-- Page Description End -->						
						<table cellpadding="2" cellspacing="1" border="0" width="95%"> 
							...
							<tr>
								...
								<td style="padding-left:10px" colspan="3">
									<input type="file" name="FileName01" size="30" value="">&nbsp;&nbsp; (92 * 92 pixel)의 사이즈로 올리세요.
								</td>
							</tr>
							<tr>
								<td height="1" bgcolor="#C4C4C4" colspan="4"></td>
							...
							-->
							<tr>
								<td width="15%" bgcolor="#E9E9E9" align="center" height="25">설 명</td>
								<td style="padding-left:10px" colspan="3" bgcolor="#FFFFFF">
									<textarea name="data" style="width:690px; height:80px"></textarea>
									<!--
