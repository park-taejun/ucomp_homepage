...
<?
	...
	$str_path = $g_physical_path."upload_data/etc/";

	//if ($str_path <> "") {
	//	$str_path =  $g_physical_path.$str_path;
	//}
	
	if ($filename_nm == "constitution.hwp") $filename_rnm = "당헌.hwp";
	if ($filename_nm == "rules.hwp") $filename_rnm = "당규.hwp";
	if ($filename_nm == "song.mp3") $filename_rnm = "당가.mp3";
