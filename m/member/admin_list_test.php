...
/*
	$(document).ready(function(){
		...
		localBody.addEventListener('scroll', function() {
			...
			var actiontoggle = "inactive";

			if((localBodyTop + localBodyHeight	> winHeight) && (actiontoggle == 'inactive')) {
	...
	*/
	...
	$(document).ready(function(){
		...
		var localBody = document.querySelector('.local-body');
		var actiontoggle = "inactive";
		var start = 1;
		var limit = 10;
		load_country_data(start, limit);
		...
		localBody.addEventListener('scroll', function() {
			...
			if(localBodyTop + localBodyHeight + 100	> winHeight)  {
				start++;
				if(actiontoggle == "inactive"){
					actiontoggle = "active";
					load_country_data(start, limit);
	...
	function load_country_data(start, limit){
		$.ajax({
			url:"fetch.php",
			method: "POST",
			data:{limit:limit, start:start},
...
<div class="goods-list" id="load_data">
