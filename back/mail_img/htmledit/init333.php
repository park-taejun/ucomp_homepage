...
<INPUT TYPE=HIDDEN ID='editSetting2' VALUE="<?=$reply_comment?>">
...
<TEXTAREA NAME='comment' ROWS=15 COLS=70 STYLE='width:100%;height:100%;padding:5px;'><?=$reply_comment?></TEXTAREA>
<!--
<TEXTAREA NAME='comment' ROWS=15 COLS=70 STYLE='width:100%;height:100%;padding:5px;'><?=$wSetContent?></TEXTAREA>
-->
<?endif;?>
<script language=javascript>
// 본문체크
function getEditCheck(signform)
{
	var f = signform;
