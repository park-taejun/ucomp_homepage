									...
									<div class="section-body">
										...
										<div class="pagination module-a style-a type-c">
											<span class="pagination-util">
												<span class="button-area">
													<button type="button" class="btn prev"><span class="btn-text">이전</span></button>
												</span>
											</span>
											...
											<span class="pagination-util">
												<span class="button-area">
													<button type="button" class="btn next"><span class="btn-text">다음</span></button>
												</span>
											</span>
											<span class="pagination-util">
												<span class="button-area">
													<a class="btn list" href="#"><span class="btn-text">목록</span></a>
												</span>
											</span>
										</div>
										<!-- //pagination -->
