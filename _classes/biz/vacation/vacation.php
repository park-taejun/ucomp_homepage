<?
	...
	function listVacation($db, $va_type, $va_user, $nPage, $nRowCount, $total_cnt) {
		...
		$query = "SELECT @rownum:= @rownum - 1  as rn, SEQ_NO, VA_TYPE, VA_SDATE, VA_EDATE, VA_MDATE, VA_MEMO, VA_USER, 
	...
	function chkVacationDatePeriod($db, $va_user, $va_sdate, $va_edate, $va_mdate, $seq_no) {
		...
		if ($seq_no == "") {
			if ($va_mdate == ""){
				...
				$mdate = explode(",", $va_mdate);
				for ($i=0;$i<count($mdate);$i++){
					$mdate[$i] = "'".$mdate[$i]."'";
				}
				$mdate = implode(",", $mdate);
				$query = "SELECT COUNT(*) FROM TBL_VACATION_DATE WHERE VA_USER = '$va_user' AND VA_DATE IN ($mdate) ";
			}
			//echo $query;
			...
			if ($va_mdate == ""){
				...
				$mdate = implode(",", $mdate);
				$query = "SELECT COUNT(*) FROM TBL_VACATION_DATE WHERE VA_USER = '$va_user' AND VA_DATE IN ($mdate) AND SEQ_NO <> '$seq_no' ";
			}
	...
	function chkVacationDatePeriodMobile($db, $va_user, $va_mdate, $seq_no) {
		...
		for($i=0 ; $i < count($mdate) ; $i++) {
			...
			$query = "SELECT COUNT(*) FROM TBL_VACATION_DATE WHERE VA_USER = '$va_user' AND VA_DATE IN ('".$mdate[$i]."') ";
...
//echo $query;
		...
		for($i=0 ; $i< $total ; $i++) {
			...
			if ($VA_STATE == 0) {
				...
				$STATE_NM = "<font color='#1098ad'>".$STATE_NM."</font>";
			} else {
				$STATE_NM = $STATE_NM;
			}
...
*/
		...
		$query = "SELECT A.ADM_ID, A.ADM_NO, A.PASSWD, A.ADM_NAME, A.ADM_INFO, A.GROUP_NO, A.ADM_HPHONE, A.ADM_PHONE, 
										 ...
										 A.USE_TF, A.DEL_TF, A.REG_ADM, A.REG_DATE, A.UP_ADM, A.UP_DATE, A.DEL_ADM, A.DEL_DATE,
										 B.DCODE_SEQ_NO, C.DCODE_SEQ_NO, B.DCODE_NM AS DEPT_NAME, C.DCODE_NM AS POSITION_NAME,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-01%'),0) AS 1M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-02%'),0) AS 2M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-03%'),0) AS 3M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-04%'),0) AS 4M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-05%'),0) AS 5M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-06%'),0) AS 6M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-07%'),0) AS 7M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-08%'),0) AS 8M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-09%'),0) AS 9M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-10%'),0) AS 10M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-11%'),0) AS 11M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-12%'),0) AS 12M,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (4,7) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$next_year."-01%'),0) AS 13M,
										 ...
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-01%'),0) AS 1B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-02%'),0) AS 2B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-03%'),0) AS 3B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-04%'),0) AS 4B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-05%'),0) AS 5B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-06%'),0) AS 6B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-07%'),0) AS 7B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-08%'),0) AS 8B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-09%'),0) AS 9B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-10%'),0) AS 10B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-11%'),0) AS 11B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (1,2,3,11,13) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$yyyy."-12%'),0) AS 12B,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE= '4' AND BB.VA_TYPE IN (4,7) AND AA.VA_USER = A.ADM_NO AND AA.VA_DATE LIKE '".$next_year."-01%'),0) AS 13B,
										 V.VA_CNT
								FROM TBL_ADMIN_INFO A 
										 LEFT OUTER JOIN TBL_ORG D ON A.ADM_NO = D.ADM_NO AND D.YEAR = '202206'
	...
	*/
		...
		$query = "SELECT A.ADM_ID, A.ADM_NO, A.PASSWD, A.ADM_NAME, A.ADM_INFO, A.GROUP_NO, A.ADM_HPHONE, A.ADM_PHONE, 
										 ...
										 A.USE_TF, A.DEL_TF, A.REG_ADM, A.REG_DATE, A.UP_ADM, A.UP_DATE, A.DEL_ADM, A.DEL_DATE,
										 B.DCODE_SEQ_NO, C.DCODE_SEQ_NO, B.DCODE_NM AS DEPT_NAME, C.DCODE_NM AS POSITION_NAME,
										 IFNULL((SELECT SUM(AA.VA_CNT) FROM TBL_VACATION_DATE AA, TBL_VACATION BB WHERE AA.SEQ_NO = BB.SEQ_NO AND BB.VA_STATE IN ('1','5') AND BB.VA_TYPE IN (19) AND AA.VA_USER = A.ADM_NO),0)
								FROM TBL_ADMIN_INFO A 
										 LEFT OUTER JOIN TBL_ORG D ON A.ADM_NO = D.ADM_NO AND D.YEAR = '202206'
										 LEFT OUTER JOIN TBL_CODE_DETAIL H ON D.HEADQUARTERS_CODE = H.DCODE AND H.USE_TF = 'Y' AND H.DEL_TF ='N' AND H.PCODE = 'HEADQUARTERS_2022'
										 LEFT OUTER JOIN TBL_CODE_DETAIL B ON D.DEPT_CODE = B.DCODE AND B.USE_TF = 'Y' AND B.DEL_TF ='N' AND B.PCODE = 'DEPT_2022'
	...
	function listMainVacationPeriod($db, $va_type, $yyyy, $va_user) {
		
		$next_year = $yyyy + 1;

		$query = "SELECT A.VA_TYPE, A.VA_SDATE, A.VA_EDATE, A.VA_PERIOD, B.VA_DATE
								FROM TBL_VACATION A INNER JOIN TBL_VACATION_DATE B
							   WHERE B.VA_DATE >=  '".$yyyy."-01-01' 
								 AND B.VA_DATE < '".$next_year."-02-01' 
								 AND A.SEQ_NO = B.SEQ_NO 
								 AND A.VA_USER = '".$va_user."' 
								 AND A.DEL_TF = 'N' 
							";

		if ($va_type == "1") {
			$query .= " AND A.VA_TYPE IN ('1','2','3','4','7','11','13') ";
		}

		if ($va_type == "5") {
			$query .= " AND A.VA_TYPE IN ('5') ";
		}

		if ($va_type == "6") {
			$query .= " AND A.VA_TYPE IN ('6','10') ";
		}

		$query .= " ORDER BY B.VA_DATE DESC ";
...
//이미지첨부건 2021-09-10
	...
	function selectVacationMobile($db, $va_date, $va_type) {
		...
		$query = "SELECT * FROM TBL_VACATION A, TBL_VACATION_DATE B 
											WHERE A.SEQ_NO = B.SEQ_NO 
												AND $str 
	...
	function listUserVacationMobile($db, $year, $va_user) {
		...
		//$y = ($year-1)."-01-01";
		$y = $year."-01-01"; 
		$query = "SELECT * FROM TBL_VACATION 
...
//echo $query;
	...
	function selectUserVacationDateMobile($db, $seq_no) {
		...
		$query = "SELECT * FROM TBL_VACATION_DATE 
											WHERE SEQ_NO = '$seq_no' 
