...
# Modify Date  : 
#	Copyright : Copyright @유컴패니온 Corp. All Rights Reserved.
# =============================================================================
					...
					<table>
						...
						?>
							<tr>
								...
								<td>
								<? if ($sPageRight_U == "Y") { ?>
									<a href="javascript:NewWindow('pop_menu_list.php?group_no=<?=$GROUP_NO?>&group_name=<?=$GROUP_NAME?>','pop_menu_list','820','650','YES')">[ + ]</a>
								<? } ?>
								</td>
								<td>
								<? if ($sPageRight_D == "Y") { ?>
