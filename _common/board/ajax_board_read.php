...
?>
							...
							<p>
								...
								<?
										for ($j = 0 ; $j < sizeof($arr_rs_files); $j++) {
											...
											if ($RS_FILE_NM <> "") {
								?>
									<a href="../../_common/new_download_file.php?menu=boardfile&file_no=<?= $RS_FILE_NO ?>"><font color="navy"><?=$RS_FILE_RNM?></font></a>
								<?
											}
											$f_Cnt = $f_Cnt + 1;
										}
					...
					<p class="btnright">
						<button type="button" class="btn-border-white" onClick="document.location='/manager/board/board_list.php?b_code=B_1_1'">목록</button>
					</p>
					<div class="sp20"></div>
					<div class="replylist">
